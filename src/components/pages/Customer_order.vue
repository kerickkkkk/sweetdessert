<template>
  <div>
    ...
    <div class="conatainer p-5 bg-cover" style=" background-image: linear-gradient(to right bottom,rgba(0,0,0, 0.8),rgba(255,255,255, 0.8)),url('https://images.unsplash.com/photo-1518843875459-f738682238a6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1326&q=80');">
      <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-10">
          <div class="row mt-4">
            <div class="col-lg-4 col-md-6 mb-4" v-for ="item in filterproduct" v-if="item.is_enabled">
              <div class="card border-0 shadow-sm" >      
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-baseline">
                    <div class="h5 ml-auto" v-if="item.origin_price == item.price">原價{{item.origin_price|currency}}元</div>
                    
                    <del class="h6" v-if="item.origin_price != item.price">原價{{item.origin_price|currency}}元</del>
                    <div class="h5" v-if="item.origin_price != item.price">現在只要
        ...
        <nav aria-label="Page navigation example" class="d-flex justify-content-center" v-if="sortStatus==='all'">
          <ul class="pagination">
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content border-0">
          ...
          <div class="modal-body">  
            <div class="bg-cover" style="height: 50vh; "  
            ...
            <!--:style="{backgroundImage: `url(${product.imageUrl})`}"好了再加上去--> 
              ...
              <p >{{product.content}}</p>
              <div class="d-flex justify-content-between align-items-baseline">
                <div class="h5" v-if="product.origin_price == product.price">原價{{product.origin_price|currency}}元</div>
                <del class="h6" v-if="product.origin_price != product.price">原價{{product.origin_price|currency}}元</del>
                <div class="h5" v-if="product.origin_price != product.price">現在只要{{product.price|currency}} 元</div>
              </div>
          ...
          <div class="modal-footer">
            ...
            >
              <i class="fas fa-spinner fa-spin"  v-if="product.id === status.addcartloadingItem"></i>加到購物車</button>
          </div>
        </div>
      </div>
    </div> 
