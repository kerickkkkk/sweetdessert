<template>
  ...
  <div class="wrap vh-100 d-flex justify-content-center align-items-center">
    <div class="col-md-6">
      <h3 class="h2 text-center text-primary mb-3"><strong>購物車內容</strong></h3>
      <table class="table  table-striped table-hover">
        ...
        <tfoot>
          ...
          <tr  v-if="carts.total != carts.final_total">
            ...
            >{{ carts.final_total }}</td>

          </tr>
        </tfoot>
      </table>
      <div class="input-group mb-3 input-group-sm">
        <input type="text" class="form-control" placeholder="請輸入優惠碼 (試試 QQ22, QQ50)"
          v-model="couponcode" @keyup.enter="addcoupon()"
        >
